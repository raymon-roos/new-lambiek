<section class="w-5/12 h-1/3">
    <div id="carousel" data-bs-ride="carousel"
        class="carousel slide carousel-fade carousel-dark w-full h-full p-3 px-8 relative border-8 border-modern_white_smoke border-opacity-25 bg-modern_white_smoke bg-opacity-80">
        ...
        <?php foreach ($randArticles as $article) { ?>
            <div class="carousel-item relative float-left w-full min-h-fit h-full max-h-[700px] object-contain object-center">
                <img src="https://www.lambiek.net/artists/image/<?= $article['imgofn'] ?>" class="object-contain object-center w-full h-full max-h-full" alt="" />
