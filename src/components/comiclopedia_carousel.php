<div id="updatedArticlesContainer"
    class="flex flex-col justify-center items-center w-1/2 p-2 my-2 mx-auto bg-modern_dark_blue text-modern_white_smoke shadow-xl">
    ...
    <div id="carouselContainer" class="flex flex-row justify-between items-center w-full">
        <svg id="chevronLeft" fill="currentColor" stroke-linecap="round" stroke-linejoin="round"
            ...
            class="w-10 py-56 mx-2 text-modern_white_smoke hover:text-modern_light_blue">
            <path d="M97.141,225.92c0-8.095,3.091-16.192,9.259-22.366L300.689,9.27c12.359-12.359,32.397-12.359,44.751,0
                c12.354,12.354,12.354,32.388,0,44.748L173.525,225.92l171.903,171.909c12.354,12.354,12.354,32.391,0,44.744
                c-12.354,12.365-32.386,12.365-44.745,0l-194.29-194.281C100.226,242.115,97.141,234.018,97.141,225.92z"/>
        </svg>
        <div id="carousel" class="select-none w-full p-2 shadow-inner" >
            <?php $i = 1;
            foreach ($updatedArticles as $article) { ?>
                <div id="carouselChild<?= $i++ ?>" class="w-full [display:none]" >
                    <a href="artist_details.php?name=<?= $article['lastname'] ?>"
                        class="flex flex-col-reverse items-center w-full h-96 bg-cover bg-center"
                        style="background-image: url(https://lambiek.net/artists/image/<?= $article['imgofn'] ?>);">
                        <h4 class="flex-wrap break-inside-auto mt-6 bg-comic_blue text-modern_white_smoke font-semibold p-1"><?= $article['name'] ?></h4>
                    </a>
                </div>
            <?php } ?>
        </div>
