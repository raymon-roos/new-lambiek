<div id="updatedArticlesContainer" class="flex flex-col justify-center items-center w-3/5 my-2 mx-auto bg-modern_dark_blue text-modern_white_smoke">
    <h1>Recently updated articles:</h1>
    <div id="carouselContainer" class="flex flex-row justify-between items-center ">
        <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" 
            stroke-width="2" viewBox="0 0 451.847 451.847" 
            class="w-10 h-30 py-[250px] text-modern_light_blue hover:text-modern_white_smoke">
