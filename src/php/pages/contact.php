    ...
    <div class="page_content">
        ...
        <div class="h-full m-10">
            <div class="mx-auto w-full max-w-lg">
                ...
                <form action="" class="p-14 bg-modern_white_smoke bg-opacity-40 rounded-xl shadow-xl mt-6">
                    ...
                    <button type="submit" class="mt-5 rounded-md  px-10 py-2 text-white bg-comic_blue">Verstuur bericht</button>
                </form>
            </div>
